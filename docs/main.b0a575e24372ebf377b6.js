...
function add_css() {
	...
	style.id = "svelte-rf2unc-style";
	style.textContent = ".main.svelte-rf2unc{display:flex;justify-content:center}";
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t1 = internal_text(/*name*/ ctx[0]);
			t2 = internal_text("!");
			attr(div, "class", "main svelte-rf2unc");
		},
		m(target, anchor) {
...
class App_svelte_App extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-rf2unc-style")) add_css();
